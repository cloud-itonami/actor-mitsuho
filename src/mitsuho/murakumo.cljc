...
(defn collection
  [name]
  (str "com.etzhayyim.mitsuho." name))

(def cell-specs {
  :field_cultivation {:legacy-cell "field-cultivation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "field_cultivation")]
     :required-gates common-gates
     :trigger "manifest cell field_cultivation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :aquaculture {:legacy-cell "aquaculture"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "aquaculture")]
     :required-gates common-gates
     :trigger "manifest cell aquaculture"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :alt_protein_fermentation {:legacy-cell "alt-protein-fermentation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "alt_protein_fermentation")]
     :required-gates common-gates
     :trigger "manifest cell alt_protein_fermentation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :harvest_robotics {:legacy-cell "harvest-robotics"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "harvest_robotics")]
     :required-gates common-gates
     :trigger "manifest cell harvest_robotics"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :food_preservation {:legacy-cell "food-preservation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "food_preservation")]
     :required-gates common-gates
     :trigger "manifest cell food_preservation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :autonomous_mobile {:legacy-cell "autonomous-mobile"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "autonomous_mobile")]
     :required-gates common-gates
     :trigger "manifest cell autonomous_mobile"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
