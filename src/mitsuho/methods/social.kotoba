(ns mitsuho.methods.social
  "social.cljc — 瑞穂 — Food / Agriculture DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from mitsuho's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "瑞穂 — Food / Agriculture が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over mitsuho's own domain (Food production Tier-B actor (plant agriculture + freshwater aquaculture + alternative protein). Delivers L2 Sustenance Tier (≥4,500 kJ/day…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "mitsuho R0: live social posting is Council Lv6+ + operator + "
